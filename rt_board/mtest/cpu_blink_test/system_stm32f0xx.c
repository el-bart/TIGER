 ...
 * @{
 */
uint32_t SystemCoreClock      = 48u*1000u*1000u;
__I uint8_t AHBPrescTable[16] = {0, 0, 0, 0,
                                 0, 0, 0, 0,
                                 1, 2, 3, 4,
                                 6, 7, 8, 9};
...
/**
 * @brief  Setup the microcontroller system. Initialize the Embedded Flash Interface, the PLL and update the SystemCoreClock variable.
 * @param  None
 * @retval None
 */
